...
class TLDetector(object):
    def __init__(self):
        ...
        self.pose = None
        self.waypoints = None
        self.waypoints_2d = None  # DONE - Additional
        self.waypoint_tree = None  # DONE - Additional
    ...
    def waypoints_cb(self, waypoints):  # DONE-Additional
    ...
    def image_cb(self, msg):
        ...
        """
        # ignore the messages if other initialization not done
        if not self.waypoint_tree:
            rospy.logwarn("skip image_cb because initialization not done")
            return

        self.has_image = True
        self.camera_image = msg
        light_wp, state = self.process_traffic_lights()
        #rospy.logwarn("process_traffic_lights: {0},{1}".format(light_wp, state))
